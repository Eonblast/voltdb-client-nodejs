...
function L(a) {
  ...
  b = a.lastIndexOf("[");
  return{type:a.substring(0, b), v:a.substring(b + 1, c)}
}
function M(a) {
...
M.prototype.setEndian = M.prototype.W = function(a) {
  this.endian = a
};
M.prototype.getEndian = M.prototype.t = function() {
  return this.endian
};
M.prototype.typedef = M.prototype.Z = function(a, b) {
  this.types[a] = b
};
M.prototype.lstypes = M.prototype.w = function() {
  var a, b = {};
  for(a in this.types) {
...
M.prototype.resolveTypedef = M.prototype.T = function(a, b, c, d, e) {
  console.log(a);
  C.z(a in this.types);
...
M.prototype.readEntry = M.prototype.H = function(a, b, c) {
  var d;
...
M.prototype.readStruct = M.prototype.Q = function(a, b, c) {
  var d, e, g, h, j = c, m = {};
  for(e = 0;e < a.length;e++) {
    h = Object.keys(a[e])[0], g = a[e][h], d = L(N(g.type, m)), "offset" in g && (c = j + g.offset), d = this.readEntry(d, b, c), c += d.size, m[h] = d.value
  }
  return{aa:m, size:c - j}
};
M.prototype.readData = M.prototype.C = function(a, b, c) {
  return this.readStruct(a, b, c).values
};
M.prototype.writeArray = M.prototype.h = function(a, b, c, d, e) {
  var g, h = e;
  g = L(b);
  for(b = 0;b < c;b++) {
...
M.prototype.writeEntry = M.prototype.ga = function(a, b, c, d) {
  var e;
...
M.prototype.writeStruct = M.prototype.oa = function(a, b, c) {
  var d, e, g, h, j = c, m = {};
...
Q.prototype.readBinary = Q.prototype.A = function(a) {
  return this.buffer.slice(this.position, this.position += a)
};
Q.prototype.writeBinary = Q.prototype.ba = function(a) {
  for(var b = 0, c = a.length, d = this.position;b < c;b++) {
    this.buffer[d + b] = a[b]
  }
  this.position += c
};
Q.prototype.readByte = Q.prototype.B = function() {
  return na(this.buffer, "big", this.position++)
};
Q.prototype.writeByte = Q.prototype.ca = function(a) {
  P(a, "big", this.buffer, this.position++)
};
Q.prototype.readShort = Q.prototype.O = function() {
  return oa(this.buffer, "big", (this.position += 2) - 2)
};
Q.prototype.writeShort = Q.prototype.ma = function(a) {
  pa(a, "big", this.buffer, (this.position += 2) - 2)
};
Q.prototype.readInt = Q.prototype.K = function() {
  return O(this.buffer, "big", (this.position += 4) - 4)
};
Q.prototype.writeInt = Q.prototype.ia = function(a) {
  qa(a, "big", this.buffer, (this.position += 4) - 4)
};
Q.prototype.readDouble = Q.prototype.G = function() {
  return ra(this.buffer, "big", (this.position += 8) - 8)
};
Q.prototype.writeDouble = Q.prototype.fa = function(a) {
  sa(a, "big", this.buffer, (this.position += 8) - 8)
};
Q.prototype.readLongBytes = Q.prototype.M = function() {
  for(var a = [], b = 0;8 > b;b++) {
...
Q.prototype.readLong = Q.prototype.L = function() {
  return this.readLongBytes()[0]
};
Q.prototype.writeLong = Q.prototype.ja = function(a) {
  "number" === typeof a && (a = new f(a.toString()));
  for(var a = a.g(), a = R(8 - a.length).concat(a), b = 0;8 > b;b++) {
    P(a[b], "big", this.buffer, this.position + b)
  }
  this.position += 8
};
Q.prototype.readString = Q.prototype.P = function() {
  return this.buffer.toString("utf8", this.position, this.position += this.readInt())
};
Q.prototype.writeString = Q.prototype.na = function(a) {
...
Q.prototype.readDate = Q.prototype.D = function() {
  var a = this.readLongBytes().p(S).toString();
  return new Date(parseInt(a))
};
Q.prototype.writeDate = Q.prototype.da = function(a) {
...
Q.prototype.readDecimal = Q.prototype.F = function() {
...
Q.prototype.writeDecimal = Q.prototype.ea = function(a) {
...
Q.prototype.readVarbinary = Q.prototype.R = function() {
  var a = this.readInt(), b = this.buffer.slice(this.position, this.position + a);
  this.position += a;
  return b
};
Q.prototype.writeVarbinary = Q.prototype.pa = function(a) {
  this.writeInt(a.length);
  a.copy(this.buffer, this.position);
  this.position += a.length
};
Q.prototype.readNull = Q.prototype.N = function() {
  return null
};
Q.prototype.writeNull = Q.prototype.ka = function() {
};
...
Q.prototype.writeArray = Q.prototype.h = function(a, b) {
  var c = b.length, d;
  if(d = a.match(V)) {
    this.writeByte(W.e);
    this.writeShort(c);
...
Q.prototype.readVoltTable = Q.prototype.S = function() {
  this.readInt();
  this.readInt();
...
Z.prototype.readHeader = Z.prototype.J = function() {
  this.length = this.readInt();
  this.protocol = this.readByte()
};
Z.prototype.writeHeader = Z.prototype.ha = function() {
  var a = this.position;
  this.position = 0;
...
Z.prototype.toBuffer = Z.prototype.Y = function() {
  this.writeHeader();
...
LoginMessage.prototype.toString = LoginMessage.prototype.toString = function() {
  return{length:this.length, protocol:this.protocol, status:this.status, error:this.error, V:this.serverId, o:this.connectionId, l:this.clusterStartTimestamp, u:this.leaderIP, k:this.build}
};
...
QueryMessage.prototype.toString = QueryMessage.prototype.toString = function() {
  return{length:this.length, protocol:this.protocol, status:this.status, error:this.error, $:this.uid, s:this.fieldsPresent, status:this.status, X:this.statusString, i:this.appStatus, j:this.appStatusString, q:this.exception, r:this.exceptionLength, U:this.results}
};
