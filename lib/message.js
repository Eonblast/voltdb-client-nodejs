...
w.prototype.writeInt = function(a) {
  ...
  0 <= a ? p(a, b, c) : p(4294967295 + a + 1, b, c)
};
...
w.prototype.writeLong = function(a) {
  ...
  for(var a = a.e(), a = x(8 - a.length).concat(a), b = 0;8 > b;b++) {
...
w.prototype.readDate = function() {
  var a = this.readLongBytes().m(y).toString();
...
w.prototype.writeParameterSet = function(a, b) {
  ...
  for(var f = 0;f < c;f++) {
    ...
    "numeric" === typeof l && !E[e] && d(Error("Providing a numeric type for a non-numeric field. " + l + " can not be a " + e));
    ...
    (e = g.match(C)) ? (g = e[1], this.writeByte(B.d), this.writeArray(g, j)) : (this.writeByte(B[g]), this[D[g]](j))
  }
};
...
"long":"readLong", bigint:"readLong", "double":"readDouble", "float":"readDouble", string:"readString", date:"readDate", timestamp:"readDate", decimal:"readDecimal", varbinary:"readVarbinary"}, D = {array:"writeArray", "null":"wrteNull", "byte":"wrteByte", tinyint:"writeByte", "short":"writeShort", smallint:"writeShort", "int":"writeInt", integer:"writeInt", "long":"writeLong", bigint:"writeLong", "double":"writeDouble", "float":"writeDouble", string:"writeString", date:"writeDate", timestamp:"writeDate", 
decimal:"writeDecimal", varbinary:"writeVarbinary"}, E = {"byte":i, tinyint:i, "short":i, smallint:i, "int":i, integer:i, "long":i, bigint:i, "double":i, "float":i, date:i, timestamp:i, decimal:i, varbinary:i}, G = {string:i, decimal:i}, H = {"long":i, bigint:i}, y = new k("1000");
function x(a) {
...
J.prototype = Object.create(w.prototype);
J.prototype.readHeader = function() {
  this.length = this.readInt();
  this.protocol = this.readByte()
};
J.prototype.writeHeader = function() {
  var a = this.position;
  this.position = 0;
...
J.readInt = function(a, b) {
  return w.readInt(a, b)
};
LoginMessage = function(a) {
  J.call(this, a);
  this.type = K.a;
  this.status = this.readByte();
  this.error = 0 === this.status ? !1 : i;
...
QueryMessage = function(a) {
  ...
  this.status = this.readByte();
  this.statusString = L[this.status];
  this.fieldsPresent & M && (this.statusString = this.readString());
  this.appStatus = this.readByte();
  this.appStatusString = "";
  this.fieldsPresent & N && (this.appStatusString = this.readString());
  this.exception;
  this.exceptionLength = this.readInt();
  if(this.fieldsPresent & O) {
...
var K = {c:-1, a:1, b:2}, M = 32, O = 64, N = 128, L = {1:"SUCCESS", "-1":"USER_ABORT", "-2":"GRACEFUL_FAILURE", "-3":"UNEXPECTED_FAILURE", "-4":"CONNECTION_LOST"};
exports.MESSAGE_TYPE = K;
exports.Message = J;
